...
A one-page tour of how Aonik is put together. Deeper architectural detail and the rationale for each choice lives in [For Contributors](/docs/for-contributors).
...
If a feature is conflating any two of these, it's a design smell. The [Glossary](/docs/getting-started/glossary) defines each precisely.
...
- **For everyday vocabulary** — [Glossary](/docs/getting-started/glossary)
- **For the full per-module breakdown** — [Platform Capabilities](/docs/platform-capabilities)
- **For the architectural rationale** — [For Contributors](/docs/for-contributors)
- **For the runtime endpoints** — [API Reference](/docs/api-reference)

## What's next

- [What you get out of the box](/docs/getting-started/what-you-get) — the module list
- [Glossary](/docs/getting-started/glossary) — canonical platform terms
- [Quickstart](/docs/getting-started/quickstart) — if you haven't run it yet
