...
<Callout type="warn" title="Coming soon">
  This section is being written in a later phase of the docs rewrite. Until then, the AI overview lives in [Architecture at a glance](/docs/getting-started/architecture-at-a-glance#how-ai-runs).
</Callout>
...
- [Architecture at a glance](/docs/getting-started/architecture-at-a-glance#how-ai-runs) — short summary of the AI pipeline
- [Glossary](/docs/getting-started/glossary#ai-platform) — AiRun, Tool, Prompt, Proposal, Approval, Agent, MCP
