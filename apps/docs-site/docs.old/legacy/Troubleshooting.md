...
1. Check the [CHANGELOG.md](https://github.com/michaeljosiah/aonik/blob/main/CHANGELOG.md) for recent changes
2. Review the [AGENTS.md](https://github.com/michaeljosiah/aonik/blob/main/AGENTS.md) coding guidelines
