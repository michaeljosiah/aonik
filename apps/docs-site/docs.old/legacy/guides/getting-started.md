...
- Auth system and claims: `../features/authentication-authorization.md`
- Auth0 setup guide: `../guides/authentication-auth0.md`
- Azure AD setup guide: `../guides/authentication-azure-ad.md`
- Local development notes: `../deployment/local-development.md`
