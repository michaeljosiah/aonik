...
void main() {
  ...
  testWidgets('end-to-end mocked card payment flow',
    ...
    await tester.tap(find.text('Pay with debit or credit card'));
    await tester.pumpAndSettle();
    await tester.tap(find.textContaining('ending in 4567').first);
    await tester.pumpAndSettle();
    ...
    expect(find.textContaining('Transaction status'), findsOneWidget);
  });
}
