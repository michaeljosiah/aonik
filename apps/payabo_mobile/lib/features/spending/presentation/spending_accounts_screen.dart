...
class SpendingAccountsScreen extends ConsumerWidget {
  ...
  Future<void> _handleReconnect(
    ...
    await _showAccountLinkSheet(
      context,
      ref,
      provider: item.providerCode ?? 'Plaid',
      mode: 'update',
...
class _AccountLinkConnectSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool isReconnect = mode == 'update';
    ...
    final String stepOneSubtitle = launcher.isNativeProviderFlow
        ? isReconnect
            ...
            : 'The app opens the native Plaid experience using a short-lived link token from AONIK.'
        : isReconnect
