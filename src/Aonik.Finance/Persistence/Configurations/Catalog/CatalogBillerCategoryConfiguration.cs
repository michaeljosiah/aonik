...
internal class CatalogBillerCategoryConfiguration : IEntityTypeConfiguration<CatalogBillerCategory>
{
    public void Configure(EntityTypeBuilder<CatalogBillerCategory> builder)
    {
        ...
        builder.HasIndex(x => new { x.TenantId, x.CountryCode, x.Name }).IsUnique();
