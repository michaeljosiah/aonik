            ...
            {loading ? (
              ...
              scenarios.map((scenario) => (
                <div
                  ...
                  role="button"
                  tabIndex={0}
                  className="flex w-full cursor-pointer items-start gap-2 border-b border-border px-3 py-2.5 text-left transition-colors last:border-b-0 hover:bg-accent"
                      ...
                      {scenario.tags.length > 0 && (
                        <div className="flex gap-1">
                          {scenario.tags.slice(0, 3).map((tag) => (
                            <span
                              key={tag}
                              className="rounded-full bg-primary/10 px-1.5 py-0 text-[9px] text-primary"
                            >
                              {tag}
                            </span>
                          ))}
