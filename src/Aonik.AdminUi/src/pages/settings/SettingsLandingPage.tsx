...
const settingsTiles: SettingsTile[] = [
  ...
  {
    section: 'AI & Agents',
    title: 'Voice & Speech (legacy)',
    description: 'Original voice settings page. Replaced by the unified Speech & Voice library; kept while phases B/C land.',
    href: '/settings/voice',
    icon: <AudioLines className="h-[18px] w-[18px]" />,
    badge: 'AI',
  },
  {
    section: 'AI & Agents',
    title: 'Speech & Voice',
    description: 'Library of speech providers (STT/TTS/Composite) plus voice recipes. The new unified surface (spec 024).',
