    ...
    <div className="flex h-full min-h-0">
      <aside className="w-80 flex-none overflow-auto border-r border-border bg-muted p-[18px]">
        ...
        <div className="flex flex-col gap-1.5">
          <button
            type="button"
            className="flex items-center gap-2.5 rounded-[10px] border border-primary bg-card p-3 text-left"
          >
      ...
      <main className="min-w-0 flex-1 overflow-auto px-8 py-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.1em] text-muted-foreground">Settings · Gateways · Flutterwave</p>
