    ...
    <Card className="h-full rounded-[4px] flex flex-col px-4 py-3">
      <div className="mb-4 flex flex-row items-center justify-between space-y-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[18px] font-bold text-foreground">My databoxes</h2>
            <p className="text-sm text-muted-foreground">Your personal and team databoxes.</p>
          </div>
        </div>
      ...
      <CardContent className="flex-1 overflow-hidden px-0 pb-0">
        ...
        <div className="visible-scrollbar divide-y divide-border overflow-y-auto max-h-[400px]">
          {databoxes.map((databox) => (
            ...
            >
              ...
              <div className="text-right flex-shrink-0 ml-4">
                <p className="text-sm text-foreground">{databox.lastModified}</p>
                <p className="text-xs text-muted-foreground">by {databox.modifiedBy}</p>
              </div>
            </div>
          ))}
        </div>
