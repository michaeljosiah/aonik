...
/**
 * shadcn Card surface (new-york v4: rounded-xl, border, shadow-xs) with the
 * part-owned padding model (each part pads itself, p-6), so the many call
 * sites that use Card as a plain padded container keep their layout.
 * CardAction sits top-right inside CardHeader.
 */
